gRoute127_MapScripts: ; 81F69D9
	map_script 3, gRoute127_MapScript1_1F69E9
	map_script 1, gRoute127_MapScript1_1F6A14
	map_script 2, gRoute127_MapScript2_1F6A2B
	.byte 0
...
gRoute127_MapScript2_1F6A2B: ; 81F6A2B
	map_script_2 0x4039, 1, gRoute127_EventScript_273D1F
	.2byte 0

gRoute127_EventScript_1F6A35: ; 81F6A35
	trainerbattle 0, TRAINER_CAMDEN, 0, gRoute127_Text_2A225F, gRoute127_Text_2A2294
	loadptr 0, gRoute127_Text_2A22A1
	callstd 6
	end

gRoute127_EventScript_1F6A4C: ; 81F6A4C
	trainerbattle 0, TRAINER_DONNY, 0, gRoute127_Text_2A22DD, gRoute127_Text_2A2315
	loadptr 0, gRoute127_Text_2A232C
	callstd 6
	end

gRoute127_EventScript_1F6A63: ; 81F6A63
	trainerbattle 0, TRAINER_JONAH, 0, gRoute127_Text_2A2381, gRoute127_Text_2A23E1
	loadptr 0, gRoute127_Text_2A240C
	callstd 6
	end

gRoute127_EventScript_1F6A7A: ; 81F6A7A
	trainerbattle 0, TRAINER_HENRY, 0, gRoute127_Text_2A2450, gRoute127_Text_2A2483
	loadptr 0, gRoute127_Text_2A2494
	callstd 6
	end

gRoute127_EventScript_1F6A91: ; 81F6A91
	trainerbattle 0, TRAINER_ROGER, 0, gRoute127_Text_2A24C6, gRoute127_Text_2A250B
	loadptr 0, gRoute127_Text_2A2538
	callstd 6
	end

gRoute127_EventScript_1F6AA8: ; 81F6AA8
	trainerbattle 0, TRAINER_AIDAN, 0, gRoute127_Text_2A257A, gRoute127_Text_2A25C1
	loadptr 0, gRoute127_Text_2A25D2
	callstd 6
	end

gRoute127_EventScript_1F6ABF: ; 81F6ABF
	trainerbattle 0, TRAINER_ATHENA, 0, gRoute127_Text_2A27D0, gRoute127_Text_2A27FC
	loadptr 0, gRoute127_Text_2A2832
	callstd 6
	end

gRoute127_EventScript_1F6AD6: ; 81F6AD6
	trainerbattle 2, TRAINER_KOJI_1, 0, gRoute127_Text_2A264D, gRoute127_Text_2A2685, gRoute127_EventScript_1F6B02
...
gRoute127_EventScript_1F6B21: ; 81F6B21
	trainerbattle 5, TRAINER_KOJI_1, 0, gRoute127_Text_2A2734, gRoute127_Text_2A276B
