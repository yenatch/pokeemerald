gRoute117_MapScripts: ; 81F397D
	.byte 3
	.4byte gRoute117_MapScript1_1F3983
	.byte 0
...
gRoute117_EventScript_1F39D0: ; 81F39D0
	trainerbattle 2, 538, 0, gRoute117_Text_29C43F, gRoute117_Text_29C47A, gRoute117_EventScript_1F39FC
...
gRoute117_EventScript_1F3A1B: ; 81F3A1B
	trainerbattle 5, 538, 0, gRoute117_Text_29C549, gRoute117_Text_29C58B
	loadptr 0, gRoute117_Text_29C5D0
	callstd 6
	end

gRoute117_EventScript_1F3A32: ; 81F3A32
	trainerbattle 2, 545, 0, gRoute117_Text_29C612, gRoute117_Text_29C659, gRoute117_EventScript_1F3A5E
	specialval 0x800d, 60
	compare 0x800d, 1
...
gRoute117_EventScript_1F3A7D: ; 81F3A7D
	trainerbattle 5, 545, 0, gRoute117_Text_29C6FD, gRoute117_Text_29C73E
	loadptr 0, gRoute117_Text_29C75A
	callstd 6
	end

gRoute117_EventScript_1F3A94: ; 81F3A94
	trainerbattle 2, 364, 0, gRoute117_Text_29C7A5, gRoute117_Text_29C7EB, gRoute117_EventScript_1F3AC0
	specialval 0x800d, 60
	compare 0x800d, 1
...
gRoute117_EventScript_1F3ADF: ; 81F3ADF
	trainerbattle 5, 364, 0, gRoute117_Text_29C880, gRoute117_Text_29C8E3
	loadptr 0, gRoute117_Text_29C8FE
	callstd 6
	end

gRoute117_EventScript_1F3AF6: ; 81F3AF6
	trainerbattle 2, 369, 0, gRoute117_Text_29C955, gRoute117_Text_29C9A6, gRoute117_EventScript_1F3B22
	specialval 0x800d, 60
	compare 0x800d, 1
...
gRoute117_EventScript_1F3B41: ; 81F3B41
	trainerbattle 5, 369, 0, gRoute117_Text_29CA7C, gRoute117_Text_29CACC
	loadptr 0, gRoute117_Text_29CAF6
	callstd 6
	end

gRoute117_EventScript_1F3B58: ; 81F3B58
	trainerbattle 0, 227, 0, gRoute117_Text_29CB32, gRoute117_Text_29CB87
	loadptr 0, gRoute117_Text_29CBAD
	callstd 6
	end

gRoute117_EventScript_1F3B6F: ; 81F3B6F
	trainerbattle 6, 287, 0, gRoute117_Text_29CC4A, gRoute117_Text_29CC8E, gRoute117_Text_29CD61, gRoute117_EventScript_1F3B9F
	specialval 0x800d, 60
	compare 0x800d, 1
...
gRoute117_EventScript_1F3BB8: ; 81F3BB8
	trainerbattle 7, 287, 0, gRoute117_Text_29CEB6, gRoute117_Text_29CEF6, gRoute117_Text_29CF6E
	loadptr 0, gRoute117_Text_29CF1C
	callstd 6
	end

gRoute117_EventScript_1F3BD3: ; 81F3BD3
	trainerbattle 6, 287, 0, gRoute117_Text_29CD9D, gRoute117_Text_29CDE9, gRoute117_Text_29CE52, gRoute117_EventScript_1F3C03
	specialval 0x800d, 60
	compare 0x800d, 1
...
gRoute117_EventScript_1F3C1C: ; 81F3C1C
	trainerbattle 7, 287, 0, gRoute117_Text_29CFAA, gRoute117_Text_29CFED, gRoute117_Text_29D053
	loadptr 0, gRoute117_Text_29CFFE
	callstd 6
	end

gRoute117_EventScript_1F3C37: ; 81F3C37
	trainerbattle 0, 755, 0, gRoute117_Text_29D0B7, gRoute117_Text_29D0F1
	loadptr 0, gRoute117_Text_29D10E
	callstd 6
	end

gRoute117_EventScript_1F3C4E: ; 81F3C4E
	trainerbattle 0, 756, 0, gRoute117_Text_29D14B, gRoute117_Text_29D189
	loadptr 0, gRoute117_Text_29D196
	callstd 6
	end

gRoute117_EventScript_1F3C65: ; 81F3C65
	trainerbattle 0, 757, 0, gRoute117_Text_29D1D1, gRoute117_Text_29D206
