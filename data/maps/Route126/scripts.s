gRoute126_MapScripts: ; 81F68C6
	.byte 3
	.4byte gRoute126_MapScript1_1F68CC
	.byte 0
...
gRoute126_EventScript_1F68D6: ; 81F68D6
	trainerbattle 0, 163, 0, gRoute126_Text_2A1C95, gRoute126_Text_2A1CC8
	loadptr 0, gRoute126_Text_2A1CDD
	callstd 6
	end

gRoute126_EventScript_1F68ED: ; 81F68ED
	trainerbattle 0, 164, 0, gRoute126_Text_2A1D2A, gRoute126_Text_2A1D63
	loadptr 0, gRoute126_Text_2A1D72
	callstd 6
	end

gRoute126_EventScript_1F6904: ; 81F6904
	trainerbattle 0, 453, 0, gRoute126_Text_2A1DAE, gRoute126_Text_2A1DC8
	loadptr 0, gRoute126_Text_2A1E03
	callstd 6
	end

gRoute126_EventScript_1F691B: ; 81F691B
	trainerbattle 0, 454, 0, gRoute126_Text_2A1E3E, gRoute126_Text_2A1E63
	loadptr 0, gRoute126_Text_2A1E70
	callstd 6
	end

gRoute126_EventScript_1F6932: ; 81F6932
	trainerbattle 0, 576, 0, gRoute126_Text_2A2063, gRoute126_Text_2A20C6
	loadptr 0, gRoute126_Text_2A20F7
	callstd 6
	end

gRoute126_EventScript_1F6949: ; 81F6949
	trainerbattle 0, 383, 0, gRoute126_Text_2A216A, gRoute126_Text_2A21A3
	loadptr 0, gRoute126_Text_2A21B8
	callstd 6
	end

gRoute126_EventScript_1F6960: ; 81F6960
	trainerbattle 0, 459, 0, gRoute126_Text_2A21EF, gRoute126_Text_2A2216
	loadptr 0, gRoute126_Text_2A222A
	callstd 6
	end

gRoute126_EventScript_1F6977: ; 81F6977
	trainerbattle 2, 377, 0, gRoute126_Text_2A1EA5, gRoute126_Text_2A1EE3, gRoute126_EventScript_1F69A3
...
gRoute126_EventScript_1F69C2: ; 81F69C2
	trainerbattle 5, 377, 0, gRoute126_Text_2A1F98, gRoute126_Text_2A1FD8
